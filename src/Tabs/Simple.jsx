...
import simpleImg from "/images/illustration-features-tab-1.svg";
    ...
    <section className="font-[Rubik]">
      <div className="flex flex-col mx-auto lg:flex-row xl:flex-row lg:gap-[5rem] xl:gap-[6rem] lg:mx-[10rem] xl:mx-[11rem]">
        <div className="w-[80vw]  lg:w-[30rem] h-full my-[1rem]">
          <img src={simpleImg} className="mx-auto"/>
        </div>
        <div className="flex flex-col my-[2rem] items-center justify-center lg:items-start">
          <h2 className="text-[1.5rem] font-[500] text-Very-Dark-Blue lg:text-[1.8rem]">Bookmark In One Click</h2>
